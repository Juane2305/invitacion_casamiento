...
const Places = () => {
  return (
    <div className='w-full pt-10 flex flex-col items-center gap-y-16'>
      <h3 className='text-center text-3xl font-thin'>6 DE ABRIL DE 2025</h3>
